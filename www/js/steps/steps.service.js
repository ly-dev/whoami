    ...
    function ($q, $log, MY_PARAMS) {
        var heightTables = {},
            ...
            determineTable = function (gender, age) {
                var result;
                var tables = zscoreTables[gender];
            ...
            determineHeightsByAge = function (gender, age) {
                var result;
                var table = heightTables[gender];
                ...
                //should not be here
                throw 'Unable to determine height table (gender:' + gender + ', age:' + age + ').';
            },

            determineWeightsByAge = function (gender, age) {
                var result;
                var table = weightTables[gender];
                ...
                //should not be here
                throw 'Unable to determine weight table (gender:' + gender + ', age:' + age + ').';
            },
            ...
            init = function () {
                ...
                // WHO weight-to-age tables, source: http://www.who.int/childgrowth/standards
                weightTables = {
                    'boy': {
                        '0': [2, 2.3, 2.5, 2.6, 2.8, 2.9, 3, 3.3, 3.7, 3.9, 4, 4.2, 4.3, 4.6, 5.1],
                        '1': [2.9, 3.2, 3.4, 3.6, 3.8, 3.9, 4.1, 4.5, 4.9, 5.1, 5.3, 5.5, 5.7, 6, 6.6],
                        '2': [3.7, 4.1, 4.4, 4.5, 4.7, 4.9, 5.1, 5.6, 6, 6.3, 6.5, 6.8, 7, 7.4, 8.1],
                        '3': [4.4, 4.8, 5.1, 5.2, 5.5, 5.6, 5.9, 6.4, 6.9, 7.2, 7.4, 7.7, 7.9, 8.3, 9.1],
                        '4': [4.9, 5.4, 5.6, 5.8, 6, 6.2, 6.5, 7, 7.6, 7.9, 8.1, 8.4, 8.6, 9.1, 9.8],
                        '5': [5.3, 5.8, 6.1, 6.2, 6.5, 6.7, 7, 7.5, 8.1, 8.4, 8.6, 9, 9.2, 9.7, 10.5],
                        '6': [5.6, 6.1, 6.4, 6.6, 6.9, 7.1, 7.4, 7.9, 8.5, 8.9, 9.1, 9.5, 9.7, 10.2, 11.1],
                        '7': [5.9, 6.4, 6.7, 6.9, 7.2, 7.4, 7.7, 8.3, 8.9, 9.3, 9.5, 9.9, 10.2, 10.7, 11.5],
                        '8': [6.1, 6.7, 7, 7.2, 7.5, 7.7, 8, 8.6, 9.3, 9.6, 9.9, 10.3, 10.5, 11.1, 12],
                        '9': [6.3, 6.9, 7.2, 7.4, 7.7, 7.9, 8.3, 8.9, 9.6, 10, 10.2, 10.6, 10.9, 11.4, 12.4],
                        '10': [6.5, 7.1, 7.5, 7.7, 8, 8.2, 8.5, 9.2, 9.9, 10.3, 10.5, 10.9, 11.2, 11.8, 12.8],
                        '11': [6.7, 7.3, 7.7, 7.9, 8.2, 8.4, 8.7, 9.4, 10.1, 10.5, 10.8, 11.2, 11.5, 12.1, 13.1],
                        '12': [6.9, 7.5, 7.8, 8.1, 8.4, 8.6, 9, 9.6, 10.4, 10.8, 11.1, 11.5, 11.8, 12.4, 13.5],
                        '13': [7, 7.6, 8, 8.2, 8.6, 8.8, 9.2, 9.9, 10.6, 11.1, 11.4, 11.8, 12.1, 12.7, 13.8],
                        '14': [7.2, 7.8, 8.2, 8.4, 8.8, 9, 9.4, 10.1, 10.9, 11.3, 11.6, 12.1, 12.4, 13, 14.1],
                        '15': [7.3, 8, 8.4, 8.6, 9, 9.2, 9.6, 10.3, 11.1, 11.6, 11.9, 12.3, 12.7, 13.3, 14.5],
                        '16': [7.5, 8.1, 8.5, 8.8, 9.1, 9.4, 9.8, 10.5, 11.3, 11.8, 12.1, 12.6, 12.9, 13.6, 14.8],
                        '17': [7.6, 8.3, 8.7, 8.9, 9.3, 9.6, 10, 10.7, 11.6, 12, 12.4, 12.9, 13.2, 13.9, 15.1],
                        '18': [7.7, 8.4, 8.9, 9.1, 9.5, 9.7, 10.1, 10.9, 11.8, 12.3, 12.6, 13.1, 13.5, 14.2, 15.4],
                        '19': [7.9, 8.6, 9, 9.3, 9.7, 9.9, 10.3, 11.1, 12, 12.5, 12.9, 13.4, 13.7, 14.4, 15.7],
                        '20': [8, 8.7, 9.2, 9.4, 9.8, 10.1, 10.5, 11.3, 12.2, 12.7, 13.1, 13.6, 14, 14.7, 16],
                        '21': [8.2, 8.9, 9.3, 9.6, 10, 10.3, 10.7, 11.5, 12.5, 13, 13.3, 13.9, 14.3, 15, 16.4],
                        '22': [8.3, 9, 9.5, 9.8, 10.2, 10.5, 10.9, 11.8, 12.7, 13.2, 13.6, 14.2, 14.5, 15.3, 16.7],
                        '23': [8.4, 9.2, 9.7, 9.9, 10.3, 10.6, 11.1, 12, 12.9, 13.4, 13.8, 14.4, 14.8, 15.6, 17],
                        '24': [8.5, 9.3, 9.8, 10.1, 10.5, 10.8, 11.3, 12.2, 13.1, 13.7, 14.1, 14.7, 15.1, 15.9, 17.3],
                        '25': [8.7, 9.5, 10, 10.2, 10.7, 11, 11.4, 12.4, 13.3, 13.9, 14.3, 14.9, 15.3, 16.1, 17.6],
                        '26': [8.8, 9.6, 10.1, 10.4, 10.8, 11.1, 11.6, 12.5, 13.6, 14.1, 14.6, 15.2, 15.6, 16.4, 18],
                        '27': [8.9, 9.7, 10.2, 10.5, 11, 11.3, 11.8, 12.7, 13.8, 14.4, 14.8, 15.4, 15.9, 16.7, 18.3],
                        '28': [9, 9.9, 10.4, 10.7, 11.1, 11.5, 12, 12.9, 14, 14.6, 15, 15.7, 16.1, 17, 18.6],
                        '29': [9.2, 10, 10.5, 10.8, 11.3, 11.6, 12.1, 13.1, 14.2, 14.8, 15.2, 15.9, 16.4, 17.3, 18.9],
                        '30': [9.3, 10.1, 10.7, 11, 11.4, 11.8, 12.3, 13.3, 14.4, 15, 15.5, 16.2, 16.6, 17.5, 19.2],
                        '31': [9.4, 10.3, 10.8, 11.1, 11.6, 11.9, 12.4, 13.5, 14.6, 15.2, 15.7, 16.4, 16.9, 17.8, 19.5],
                        '32': [9.5, 10.4, 10.9, 11.2, 11.7, 12.1, 12.6, 13.7, 14.8, 15.5, 15.9, 16.6, 17.1, 18, 19.8],
                        '33': [9.6, 10.5, 11.1, 11.4, 11.9, 12.2, 12.8, 13.8, 15, 15.7, 16.1, 16.9, 17.3, 18.3, 20.1],
                        '34': [9.7, 10.6, 11.2, 11.5, 12, 12.4, 12.9, 14, 15.2, 15.9, 16.3, 17.1, 17.6, 18.6, 20.4],
                        '35': [9.8, 10.7, 11.3, 11.6, 12.2, 12.5, 13.1, 14.2, 15.4, 16.1, 16.6, 17.3, 17.8, 18.8, 20.7],
                        '36': [9.9, 10.8, 11.4, 11.8, 12.3, 12.7, 13.2, 14.3, 15.6, 16.3, 16.8, 17.5, 18, 19.1, 21],
                        '37': [10, 11, 11.6, 11.9, 12.4, 12.8, 13.4, 14.5, 15.8, 16.5, 17, 17.8, 18.3, 19.3, 21.2],
                        '38': [10.1, 11.1, 11.7, 12, 12.6, 12.9, 13.5, 14.7, 15.9, 16.7, 17.2, 18, 18.5, 19.6, 21.5],
                        '39': [10.2, 11.2, 11.8, 12.2, 12.7, 13.1, 13.7, 14.8, 16.1, 16.9, 17.4, 18.2, 18.7, 19.8, 21.8],
                        '40': [10.3, 11.3, 11.9, 12.3, 12.8, 13.2, 13.8, 15, 16.3, 17.1, 17.6, 18.4, 19, 20.1, 22.1],
                        '41': [10.4, 11.4, 12.1, 12.4, 13, 13.4, 14, 15.2, 16.5, 17.3, 17.8, 18.6, 19.2, 20.3, 22.4],
                        '42': [10.5, 11.5, 12.2, 12.5, 13.1, 13.5, 14.1, 15.3, 16.7, 17.5, 18, 18.9, 19.4, 20.6, 22.7],
                        '43': [10.6, 11.7, 12.3, 12.7, 13.2, 13.6, 14.3, 15.5, 16.9, 17.7, 18.2, 19.1, 19.7, 20.8, 23],
                        '44': [10.7, 11.8, 12.4, 12.8, 13.4, 13.8, 14.4, 15.7, 17.1, 17.9, 18.4, 19.3, 19.9, 21.1, 23.3],
                        '45': [10.8, 11.9, 12.5, 12.9, 13.5, 13.9, 14.6, 15.8, 17.3, 18.1, 18.6, 19.5, 20.1, 21.3, 23.6],
                        '46': [10.9, 12, 12.7, 13, 13.6, 14.1, 14.7, 16, 17.4, 18.3, 18.9, 19.8, 20.4, 21.6, 23.9],
                        '47': [11, 12.1, 12.8, 13.2, 13.8, 14.2, 14.9, 16.2, 17.6, 18.5, 19.1, 20, 20.6, 21.9, 24.2],
                        '48': [11.1, 12.2, 12.9, 13.3, 13.9, 14.3, 15, 16.3, 17.8, 18.7, 19.3, 20.2, 20.9, 22.1, 24.5],
                        '49': [11.2, 12.3, 13, 13.4, 14, 14.5, 15.2, 16.5, 18, 18.9, 19.5, 20.4, 21.1, 22.4, 24.8],
                        '50': [11.3, 12.4, 13.1, 13.5, 14.2, 14.6, 15.3, 16.7, 18.2, 19.1, 19.7, 20.7, 21.3, 22.6, 25.1],
                        '51': [11.4, 12.5, 13.3, 13.7, 14.3, 14.7, 15.4, 16.8, 18.4, 19.3, 19.9, 20.9, 21.6, 22.9, 25.4],
                        '52': [11.5, 12.6, 13.4, 13.8, 14.4, 14.9, 15.6, 17, 18.6, 19.5, 20.1, 21.1, 21.8, 23.2, 25.7],
                        '53': [11.6, 12.7, 13.5, 13.9, 14.6, 15, 15.7, 17.2, 18.8, 19.7, 20.3, 21.4, 22.1, 23.4, 26],
                        '54': [11.7, 12.9, 13.6, 14, 14.7, 15.2, 15.9, 17.3, 19, 19.9, 20.6, 21.6, 22.3, 23.7, 26.3],
                        '55': [11.8, 13, 13.7, 14.1, 14.8, 15.3, 16, 17.5, 19.2, 20.1, 20.8, 21.8, 22.5, 24, 26.6],
                        '56': [11.9, 13.1, 13.8, 14.3, 14.9, 15.4, 16.2, 17.7, 19.3, 20.3, 21, 22.1, 22.8, 24.2, 27],
                        '57': [12, 13.2, 13.9, 14.4, 15.1, 15.6, 16.3, 17.8, 19.5, 20.5, 21.2, 22.3, 23, 24.5, 27.3],
                        '58': [12, 13.3, 14.1, 14.5, 15.2, 15.7, 16.5, 18, 19.7, 20.7, 21.4, 22.5, 23.3, 24.8, 27.6],
                        '59': [12.1, 13.4, 14.2, 14.6, 15.3, 15.8, 16.6, 18.2, 19.9, 20.9, 21.6, 22.8, 23.5, 25, 27.9],
                        '60': [12.2, 13.5, 14.3, 14.7, 15.5, 16, 16.7, 18.3, 20.1, 21.1, 21.9, 23, 23.8, 25.3, 28.2]

                    },
                    'girl': {
                        '0': [2, 2.3, 2.4, 2.5, 2.7, 2.8, 2.9, 3.2, 3.6, 3.7, 3.9, 4, 4.2, 4.4, 4.8],
                        '1': [2.7, 3, 3.2, 3.3, 3.5, 3.6, 3.8, 4.2, 4.6, 4.8, 5, 5.2, 5.4, 5.7, 6.3],
                        '2': [3.4, 3.8, 4, 4.1, 4.3, 4.5, 4.7, 5.1, 5.6, 5.9, 6, 6.3, 6.5, 6.9, 7.6],
                        '3': [3.9, 4.4, 4.6, 4.7, 5, 5.1, 5.4, 5.8, 6.4, 6.7, 6.9, 7.2, 7.4, 7.8, 8.6],
                        '4': [4.4, 4.8, 5.1, 5.2, 5.5, 5.6, 5.9, 6.4, 7, 7.3, 7.5, 7.9, 8.1, 8.6, 9.4],
                        '5': [4.7, 5.2, 5.5, 5.6, 5.9, 6.1, 6.4, 6.9, 7.5, 7.8, 8.1, 8.4, 8.7, 9.2, 10.1],
                        '6': [5, 5.5, 5.8, 6, 6.2, 6.4, 6.7, 7.3, 7.9, 8.3, 8.5, 8.9, 9.2, 9.7, 10.7],
                        '7': [5.3, 5.8, 6.1, 6.3, 6.5, 6.7, 7, 7.6, 8.3, 8.7, 8.9, 9.4, 9.6, 10.2, 11.2],
                        '8': [5.5, 6, 6.3, 6.5, 6.8, 7, 7.3, 7.9, 8.6, 9, 9.3, 9.7, 10, 10.6, 11.7],
                        '9': [5.7, 6.2, 6.6, 6.8, 7, 7.3, 7.6, 8.2, 8.9, 9.3, 9.6, 10.1, 10.4, 11, 12.1],
                        '10': [5.9, 6.4, 6.8, 7, 7.3, 7.5, 7.8, 8.5, 9.2, 9.6, 9.9, 10.4, 10.7, 11.3, 12.5],
                        '11': [6, 6.6, 7, 7.2, 7.5, 7.7, 8, 8.7, 9.5, 9.9, 10.2, 10.7, 11, 11.7, 12.9],
                        '12': [6.2, 6.8, 7.1, 7.3, 7.7, 7.9, 8.2, 8.9, 9.7, 10.2, 10.5, 11, 11.3, 12, 13.3],
                        '13': [6.4, 6.9, 7.3, 7.5, 7.9, 8.1, 8.4, 9.2, 10, 10.4, 10.8, 11.3, 11.6, 12.3, 13.6],
                        '14': [6.5, 7.1, 7.5, 7.7, 8, 8.3, 8.6, 9.4, 10.2, 10.7, 11, 11.5, 11.9, 12.6, 14],
                        '15': [6.7, 7.3, 7.7, 7.9, 8.2, 8.5, 8.8, 9.6, 10.4, 10.9, 11.3, 11.8, 12.2, 12.9, 14.3],
                        '16': [6.8, 7.4, 7.8, 8.1, 8.4, 8.7, 9, 9.8, 10.7, 11.2, 11.5, 12.1, 12.5, 13.2, 14.6],
                        '17': [7, 7.6, 8, 8.2, 8.6, 8.8, 9.2, 10, 10.9, 11.4, 11.8, 12.3, 12.7, 13.5, 15],
                        '18': [7.1, 7.8, 8.2, 8.4, 8.8, 9, 9.4, 10.2, 11.1, 11.6, 12, 12.6, 13, 13.8, 15.3],
                        '19': [7.3, 7.9, 8.3, 8.6, 8.9, 9.2, 9.6, 10.4, 11.4, 11.9, 12.3, 12.9, 13.3, 14.1, 15.6],
                        '20': [7.4, 8.1, 8.5, 8.7, 9.1, 9.4, 9.8, 10.6, 11.6, 12.1, 12.5, 13.1, 13.5, 14.4, 15.9],
                        '21': [7.6, 8.2, 8.7, 8.9, 9.3, 9.6, 10, 10.9, 11.8, 12.4, 12.8, 13.4, 13.8, 14.6, 16.2],
                        '22': [7.7, 8.4, 8.8, 9.1, 9.5, 9.8, 10.2, 11.1, 12, 12.6, 13, 13.6, 14.1, 14.9, 16.6],
                        '23': [7.8, 8.5, 9, 9.2, 9.7, 9.9, 10.4, 11.3, 12.3, 12.8, 13.3, 13.9, 14.3, 15.2, 16.9],
                        '24': [8, 8.7, 9.2, 9.4, 9.8, 10.1, 10.6, 11.5, 12.5, 13.1, 13.5, 14.2, 14.6, 15.5, 17.2],
                        '25': [8.1, 8.9, 9.3, 9.6, 10, 10.3, 10.8, 11.7, 12.7, 13.3, 13.8, 14.4, 14.9, 15.8, 17.6],
                        '26': [8.3, 9, 9.5, 9.8, 10.2, 10.5, 10.9, 11.9, 12.9, 13.6, 14, 14.7, 15.2, 16.1, 17.9],
                        '27': [8.4, 9.2, 9.6, 9.9, 10.4, 10.7, 11.1, 12.1, 13.2, 13.8, 14.3, 15, 15.4, 16.4, 18.2],
                        '28': [8.5, 9.3, 9.8, 10.1, 10.5, 10.8, 11.3, 12.3, 13.4, 14, 14.5, 15.2, 15.7, 16.7, 18.6],
                        '29': [8.7, 9.5, 10, 10.2, 10.7, 11, 11.5, 12.5, 13.6, 14.3, 14.7, 15.5, 16, 17, 18.9],
                        '30': [8.8, 9.6, 10.1, 10.4, 10.9, 11.2, 11.7, 12.7, 13.8, 14.5, 15, 15.7, 16.2, 17.3, 19.2],
                        '31': [8.9, 9.7, 10.3, 10.5, 11, 11.3, 11.9, 12.9, 14.1, 14.7, 15.2, 16, 16.5, 17.6, 19.6],
                        '32': [9, 9.9, 10.4, 10.7, 11.2, 11.5, 12, 13.1, 14.3, 15, 15.5, 16.2, 16.8, 17.8, 19.9],
                        '33': [9.2, 10, 10.5, 10.8, 11.3, 11.7, 12.2, 13.3, 14.5, 15.2, 15.7, 16.5, 17, 18.1, 20.2],
                        '34': [9.3, 10.1, 10.7, 11, 11.5, 11.8, 12.4, 13.5, 14.7, 15.4, 15.9, 16.8, 17.3, 18.4, 20.6],
                        '35': [9.4, 10.3, 10.8, 11.1, 11.6, 12, 12.5, 13.7, 14.9, 15.7, 16.2, 17, 17.6, 18.7, 20.9],
                        '36': [9.5, 10.4, 11, 11.3, 11.8, 12.1, 12.7, 13.9, 15.1, 15.9, 16.4, 17.3, 17.8, 19, 21.2],
                        '37': [9.6, 10.5, 11.1, 11.4, 11.9, 12.3, 12.9, 14, 15.3, 16.1, 16.7, 17.5, 18.1, 19.3, 21.6],
                        '38': [9.7, 10.6, 11.2, 11.6, 12.1, 12.5, 13, 14.2, 15.6, 16.3, 16.9, 17.8, 18.4, 19.6, 21.9],
                        '39': [9.8, 10.8, 11.4, 11.7, 12.2, 12.6, 13.2, 14.4, 15.8, 16.6, 17.1, 18, 18.6, 19.9, 22.3],
                        '40': [10, 10.9, 11.5, 11.8, 12.4, 12.8, 13.4, 14.6, 16, 16.8, 17.4, 18.3, 18.9, 20.2, 22.6],
                        '41': [10.1, 11, 11.6, 12, 12.5, 12.9, 13.5, 14.8, 16.2, 17, 17.6, 18.6, 19.2, 20.5, 23],
                        '42': [10.2, 11.1, 11.8, 12.1, 12.7, 13.1, 13.7, 15, 16.4, 17.3, 17.9, 18.8, 19.5, 20.8, 23.3],
                        '43': [10.3, 11.3, 11.9, 12.2, 12.8, 13.2, 13.9, 15.2, 16.6, 17.5, 18.1, 19.1, 19.7, 21.1, 23.7],
                        '44': [10.4, 11.4, 12, 12.4, 13, 13.4, 14, 15.3, 16.8, 17.7, 18.3, 19.3, 20, 21.4, 24.1],
                        '45': [10.5, 11.5, 12.1, 12.5, 13.1, 13.5, 14.2, 15.5, 17, 17.9, 18.6, 19.6, 20.3, 21.7, 24.4],
                        '46': [10.6, 11.6, 12.3, 12.6, 13.2, 13.7, 14.3, 15.7, 17.3, 18.2, 18.8, 19.9, 20.6, 22, 24.8],
                        '47': [10.7, 11.7, 12.4, 12.8, 13.4, 13.8, 14.5, 15.9, 17.5, 18.4, 19.1, 20.1, 20.8, 22.3, 25.2],
                        '48': [10.8, 11.8, 12.5, 12.9, 13.5, 14, 14.7, 16.1, 17.7, 18.6, 19.3, 20.4, 21.1, 22.6, 25.5],
                        '49': [10.9, 11.9, 12.6, 13, 13.7, 14.1, 14.8, 16.3, 17.9, 18.9, 19.5, 20.6, 21.4, 22.9, 25.9],
                        '50': [11, 12.1, 12.8, 13.2, 13.8, 14.3, 15, 16.4, 18.1, 19.1, 19.8, 20.9, 21.7, 23.2, 26.3],
                        '51': [11.1, 12.2, 12.9, 13.3, 13.9, 14.4, 15.1, 16.6, 18.3, 19.3, 20, 21.2, 22, 23.5, 26.7],
                        '52': [11.2, 12.3, 13, 13.4, 14.1, 14.5, 15.3, 16.8, 18.5, 19.5, 20.3, 21.4, 22.2, 23.9, 27],
                        '53': [11.3, 12.4, 13.1, 13.5, 14.2, 14.7, 15.4, 17, 18.7, 19.8, 20.5, 21.7, 22.5, 24.2, 27.4],
                        '54': [11.3, 12.5, 13.2, 13.7, 14.3, 14.8, 15.6, 17.2, 18.9, 20, 20.8, 22, 22.8, 24.5, 27.8],
                        '55': [11.4, 12.6, 13.4, 13.8, 14.5, 15, 15.8, 17.3, 19.1, 20.2, 21, 22.2, 23.1, 24.8, 28.2],
                        '56': [11.5, 12.7, 13.5, 13.9, 14.6, 15.1, 15.9, 17.5, 19.3, 20.4, 21.2, 22.5, 23.3, 25.1, 28.5],
                        '57': [11.6, 12.8, 13.6, 14, 14.8, 15.3, 16.1, 17.7, 19.6, 20.7, 21.5, 22.7, 23.6, 25.4, 28.9],
                        '58': [11.7, 12.9, 13.7, 14.2, 14.9, 15.4, 16.2, 17.9, 19.8, 20.9, 21.7, 23, 23.9, 25.7, 29.3],
                        '59': [11.8, 13.1, 13.8, 14.3, 15, 15.5, 16.4, 18, 20, 21.1, 21.9, 23.3, 24.2, 26, 29.6],
                        '60': [11.9, 13.2, 14, 14.4, 15.2, 15.7, 16.5, 18.2, 20.2, 21.3, 22.2, 23.5, 24.4, 26.3, 30]
                    }
                };
        ...
        service.getHeightsByAge = function (gender, age) {
            return determineHeightsByAge(gender, age);
        };

        service.getInitialHeight = function (gender, age) {
            var heights = determineHeightsByAge(gender, age);
            return Math.round(parseFloat(heights[7]));
        };

        service.getWeightsByAge = function (gender, age) {
            return determineWeightsByAge(gender, age);
        };
...
.factory('MySteps', ['$q', '$log', '$state', 'MY_PARAMS', 'MyDiagnose',
    function ($q, $log, $state, MY_PARAMS, myDiagnose) {
        ...
        service.getSummary = function () {
            ...
            angular.forEach(result, function (value, key) {
                if (key != 'height'  && key != 'weight') {
                    var func = service.getStepSummary(key);
        ...
        service.getHeightBarOptions = function () {
            if (result['height'] == null) {
                return null;
            }

            var heights = myDiagnose.getHeightsByAge(result['gender'], result['age']);
            return {
                range: [heights[0], heights[4], heights[6], heights[8], heights[10], heights[14]],
                value: result['height'],
                text: template['height'].summary(result['height'])
            };
        };

        service.getWeightBarOptions = function () {
            if (result['weight'] == null) {
                return null;
            }

            var weights = myDiagnose.getWeightsByAge(result['gender'], result['age']);
            return {
                range: [weights[0], weights[4], weights[6], weights[8], weights[10], weights[14]],
                value: result['weight'] / 1000,
                text: template['weight'].summary(result['weight'])
            };
        };
